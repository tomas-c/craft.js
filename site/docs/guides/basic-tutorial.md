...
```bash
yarn add @tomas-c/craftjs-core
```

or with npm:
```bash
npm install --save @tomas-c/craftjs-core
```
...
```jsx {2,7,10,11,13}
// components/user/Card.js
import {useNode, Element} from "@tomas-c/craftjs-core";
...
import Text from "./Text";
import Button from "./Button";
import { Element, useNode } from "@tomas-c/craftjs-core";
